...
public class IMDBAllDataTypeTest
{
    ...
    private void assertActors(ActorAllDataType actor1, ActorAllDataType actor2)
    {
        ...
        Assert.assertEquals(new Date(
                Long.parseLong("1351667541111")), actor1.getEnrolmentDate());
        Assert.assertEquals(new Date(Long.parseLong("1351667542222")), actor1.getEnrolmentTime());
        Assert.assertEquals(new Date(
                Long.parseLong("1351667543333")), actor1.getJoiningDateAndTime());
    ...
    {        
        ...
        role1.setActor(actor1); role1.setMovie(movie1);
        ...
        role2.setActor(actor1); role2.setMovie(movie2);
        
        RoleAllDataType role3 = new RoleAllDataType("Claire Phelps", "Lead Actress", 3, 354354356l, true, 'C', (byte) 10,
                (short) 7, 3.9f, 6.9, new Date(Long.parseLong("1351667547777")), new Date(
        ...
        role3.setActor(actor2); role1.setMovie(movie2);
        
        RoleAllDataType role4 = new RoleAllDataType("Sophie", "Supporting Actress", 4, 354354357l, false, 'D', (byte) 11,
                (short) 5, 3.7f, 7.0, new Date(Long.parseLong("1351667551111")), new Date(
